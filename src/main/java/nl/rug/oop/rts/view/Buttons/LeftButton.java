...
/**
 * button class for the arrow pointing to the left.
 */
public class LeftButton extends JButton {
     ...
     */
    public LeftButton() {
        ImageIcon idleBig    = new ImageIcon(getClass().getResource("/images/buttons/leftarrow.png"));
        ImageIcon pressedBig = new ImageIcon(getClass().getResource("/images/buttonsSelected/leftarrowON.png"));
