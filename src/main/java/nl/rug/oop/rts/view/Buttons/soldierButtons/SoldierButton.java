package nl.rug.oop.rts.view.Buttons.soldierButtons;

import javax.swing.*;
import java.awt.*;

/**
 * button class for the type of soldier the player can pick.
 */
public abstract class SoldierButton extends JButton {
    /**
     * size of the button.
     */
